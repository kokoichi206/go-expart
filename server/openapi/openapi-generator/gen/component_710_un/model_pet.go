...
func (o *Pet) UnmarshalJSON(bytes []byte) (err error) {
	...
	requiredProperties := map[string] func() (bool) {
		"id": func() (bool) {
			_, ok := o.GetIdOk()
			return ok
		},
	...
	for k, fn := range requiredProperties {
		if !fn() {
			return fmt.Errorf("no value given for required property %v", k)
		}
	}
