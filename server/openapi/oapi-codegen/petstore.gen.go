...
type ClientInterface interface {
	...
	// UpdatePet request
	UpdatePet(ctx context.Context, petId int64, params *UpdatePetParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) UpdatePet(ctx context.Context, petId int64, params *UpdatePetParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdatePetRequest(c.Server, petId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewUpdatePetRequest generates requests for UpdatePet
func NewUpdatePetRequest(server string, petId int64, params *UpdatePetParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// UpdatePetWithResponse request
	UpdatePetWithResponse(ctx context.Context, petId int64, params *UpdatePetParams, reqEditors ...RequestEditorFn) (*UpdatePetResponse, error)
}
...
// UpdatePetWithResponse request returning *UpdatePetResponse
func (c *ClientWithResponses) UpdatePetWithResponse(ctx context.Context, petId int64, params *UpdatePetParams, reqEditors ...RequestEditorFn) (*UpdatePetResponse, error) {
	rsp, err := c.UpdatePet(ctx, petId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
